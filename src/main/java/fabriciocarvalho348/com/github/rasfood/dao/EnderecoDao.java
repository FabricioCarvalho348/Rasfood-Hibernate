package fabriciocarvalho348.com.github.rasfood.dao;

import fabriciocarvalho348.com.github.rasfood.entity.Categoria;
import fabriciocarvalho348.com.github.rasfood.entity.Endereco;
import fabriciocarvalho348.com.github.rasfood.vo.ClienteVo;
...
public class EnderecoDao {
    ...
    public List<ClienteVo> consultarClientes(final String estado, final String cidade, final String rua) {
        String jpql = "SELECT new fabriciocarvalho348.com.github.rasfood.vo.ClienteVo(e.cliente.clienteId.cpf,e.cliente.nome) " +
        ...
        if(Objects.nonNull(rua)){
            jpql = jpql.concat("AND UPPER(e.cidade) = UPPER(:rua) ");
        }
