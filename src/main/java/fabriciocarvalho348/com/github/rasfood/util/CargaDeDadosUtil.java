...
import fabriciocarvalho348.com.github.rasfood.dao.*;
import fabriciocarvalho348.com.github.rasfood.entity.*;
...
public class CargaDeDadosUtil {
    ...
    public static void cadastrarClientes(EntityManager entityManager){
        ...
        Cliente tayane = new Cliente("111111111123","tayane@email.com","Tayane Lopes");
